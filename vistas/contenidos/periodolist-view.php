...
<div class="container-fluid"  style="margin: 50px 0;">
  <div class="row">
    <div class="col-xs-12 col-sm-4 col-md-3">
      <img src="<?php echo SERVERURL; ?>/vistas/assets/img/periodo.png" class="img-responsive center-box" style="max-width: 110px;">
    </div>
    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead text-titles">
      Bienvenido a la sección donde se encuentra el listado de períodos del instituto. Puedes actualizar o eliminar los datos de los períodos, si hay períodos ya iniciados o el estado este activo no debes eliminarlo.
    </div>
  </div>
</div>
<div class="container-fluid">
  <div class="row">
    <div class="col-xs-12 lead">
      <ol class="breadcrumb text-titles" style="color: rgba(22, 184, 176); font-size: 21px; font-weight: bold;">
        <li><a href="<?php echo SERVERURL; ?>periodo/">Nueva Período</a></li>
        <li class="active">Listado de Períodos</li>
      </ol>
    </div>
  </div>
</div>
<?php 
  ...
  $insPeriodo = new periodoControlador();
?>
<div class="container-fluid">
  <div class="panel panel-success">
  <br>
  <h2 class="text-center text-titles" style="color: rgba(22, 184, 176); font-size: 35px; font-weight: bold;">Lista de Períodos</h2>
  <br>
  <div class="panel-body">
     <?php  
        $pagina = explode("/", $_GET['views']);
        echo $insPeriodo->paginador_periodo_controlador($pagina[1],7);
      ?>
  </div>
  </div>
</div>