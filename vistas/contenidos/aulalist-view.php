 ...
 <div class="container-fluid"  style="margin: 50px 0;">
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead text-titles">
      Bienvenido a la sección donde se encuentra el listado de salones del instituto. Puedes actualizar o eliminar los datos de los salones.
    </div>
  </div>
</div>
<div class="container-fluid">
  <div class="row">
    <div class="col-xs-12 lead">
      <ol class="breadcrumb text-titles" style="color: rgba(22, 184, 176); font-size: 21px; font-weight: bold;">
        <li><a href="<?php echo SERVERURL; ?>aula/">Nuevo Salón</a></li>
...
<?php 
    ...
    $insAula = new aulaControlador();
?>
<div class="container-fluid">
  <div class="panel panel-success">
  <br>
  <h2 class="text-center text-titles" style="color: rgba(22, 184, 176); font-size: 35px; font-weight: bold;">Lista de Salones</h2>
  <br>
  <div class="panel-body">
    <?php  
      $pagina = explode("/", $_GET['views']);
      echo $insAula->paginador_aula_controlador($pagina[1],7);
    ?>
  </div>
  </div>
</div>