...
<!-- Contenido Listado Categoría -->
<div class="container-fluid"  style="margin: 50px 0;">
  <div class="row">
    <div class="col-xs-12 col-sm-4 col-md-3">
      <img src="<?php echo SERVERURL; ?>/vistas/assets/img/categoria.png" alt="categoria" class="img-responsive center-box" style="max-width: 110px;">
    </div>
    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead text-titles">
      Bienvenido a la sección donde se encuentra el listado de categorías de los cursos. Puedes actualizar o eliminar los datos de las categorías, siempre y cuando tengas los permisos necesarios.
    </div>
  </div>
</div>
<div class="container-fluid">
  <div class="row">
    <div class="col-xs-12 lead">
      <ol class="breadcrumb text-titles" style="color: rgba(22, 184, 176); font-size: 21px; font-weight: bold;">
        <li><a href="<?php echo SERVERURL; ?>categoria/">Nueva Categoría</a></li>
...
<div class="container-fluid">
  ...
  <br>
  <h2 class="text-center text-titles" style="color: rgba(22, 184, 176); font-size: 35px; font-weight: bold;">Lista de Categorías</h2>
  <br>
  <div class="panel-body">
      <?php  
        $pagina = explode("/", $_GET['views']);
        echo $insCategoria->paginador_categoria_controlador($pagina[1],7);
      ?>
  </div>
  </div>
</div>